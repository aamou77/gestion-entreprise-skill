...
function validateCommonFields(input: Record<string, unknown>, errors: ValidationError[]): void {
...
function validateUnitMode(input: Record<string, unknown>, errors: ValidationError[]): void {
...
function validateGlobalMode(input: Record<string, unknown>, errors: ValidationError[]): void {
