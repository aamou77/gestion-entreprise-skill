...
export type CalculationMode =
  ...
  | "prix_cible_taux_marque"
  | "prix_cible_taux_marge"
  | "remise";
...
export type FormulaId =
  ...
  | "MARK_RATE"
  | "MARGIN_RATE"
  | "ECONOMIC_MINIMUM_PRICE"
  | "TARGET_PRICE_FROM_MARK_RATE"
  | "TARGET_PRICE_FROM_MARGIN_RATE"
  | "DISCOUNT_AMOUNT"
...
export type Provenance = { formula_id: FormulaId; inputs_used: string[] };
