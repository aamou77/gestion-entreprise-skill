...
export type ReportedIndicatorKey =
  | "solde_tresorerie"
...
export type ValidationErrorCode =
  ...
  | "INVALID_AMOUNT"
  | "INVALID_PERIMETER"
  | "INCONSISTENT_DATA_STATE";

export type ValidationError = { field: string; code: ValidationErrorCode; message: string };
...
export type ManagementSummaryResult = {
  ...
  provenance: { solde_de_gestion_estime?: Provenance };
};
